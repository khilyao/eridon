              ...
              <ul className={s.subList}>
                <li>
                  ...
                  >
                    ...
                    , ул. Сулейменова 23/2А, офисы №6, 12,
                  </a>{" "}
                  моб.{" "}
                ...
                <li>
                  ...
                  >
                    {" "}
                    <span className={s.bold}>с. Новоишимское</span>
                  </a>
                  , моб.{" "}
                ...
                <li>
                  ...
                  >
                    <span className={s.bold}>Область Абай, г. Семей</span>
                  </a>
                  , моб.{" "}
